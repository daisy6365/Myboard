...
class FoodActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                .enqueue(object : Callback<PostListDTO> {
                    override fun onResponse(call: Call<PostListDTO>, response: Response<PostListDTO>) {
                        if (response.isSuccessful) {
                            ...
                            board_recycler.layoutManager = LinearLayoutManager(this@FoodActivity)
        ...
        writeicon.setOnClickListener {
            val postWritingintent = Intent(this@FoodActivity, PostWritingActivity::class.java)
