...
class JobActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                .enqueue(object : Callback<PostListDTO>{
                    override fun onResponse(call: Call<PostListDTO>, response: Response<PostListDTO>) {
                        if (response.isSuccessful) {
                            ...
                            board_recycler.layoutManager = LinearLayoutManager(this@JobActivity)
        ...
        writeicon.setOnClickListener {
            val postWritingintent = Intent(this@JobActivity, PostWritingActivity::class.java)
