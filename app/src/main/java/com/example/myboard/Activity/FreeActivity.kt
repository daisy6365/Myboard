...
class FreeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                .enqueue(object : Callback<PostListDTO>{
                    override fun onResponse(call: Call<PostListDTO>, response: Response<PostListDTO>) {
                        if (response.isSuccessful) {
                            ...
                            board_recycler.layoutManager = LinearLayoutManager(this@FreeActivity)
        ...
        writeicon.setOnClickListener {
            val postWritingintent = Intent(this@FreeActivity, PostWritingActivity::class.java)
